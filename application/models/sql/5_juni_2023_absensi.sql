...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jun 2023 pada 16.26
...
(1, 'DASHBOARD', 'dashboard', 'fas fa-laptop', NULL, 1, 0, 0),
...
(34, 'check', 'ayam_jago', 'fa fa-search-plus', NULL, 1, 0, 0),
(35, 'User management', 'users', 'fa fa-users', NULL, 1, 42, 13),
(36, 'Hasil Absensi', 'presensi', 'fa fa-list-alt', NULL, 1, 41, 9),
(41, 'Data rekap', 'data_absensi', 'far fa-folder-open', NULL, 1, 0, 8),
(42, 'setting', 'setting', 'fas fa-gears', NULL, 1, 0, 11),
(46, 'hasil check ayam jago', 'rekap', 'fa fa-list-alt', NULL, 1, 41, 0),
...
(26, '::1', 'admin@admin.com', '$2y$12$MPcQlOck9fzd/5UjJ6iIXuhZivhkXdfoVD2xFXpZTnZ2IWQw/nFhW', 'admin@admin.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1556798313, 1685965442, 1, 'admin', 'nistator', NULL, '123412341234'),
