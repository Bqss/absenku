...
class Presensi_model extends CI_Model
{
  ...
  // adding new fc to get presensi based on the kegiatan's id ;

  function getByKegiatan($id_kegiatan)
  {
    return $this->db->query("select * from presensi_siswa inner join siswa on presensi_siswa.nis = siswa.nis where id_kegiatan=$id_kegiatan")->result();
  }
