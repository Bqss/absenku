          ...
          <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control" name="nis" id="nis" readonly data-error="NIS Siswa harus diisi" maxlength="11" placeholder="NIS" required value="<?= $nis ?>"/>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control" name="nama" id="nama" data-error="Nama Siswa harus diisi" placeholder="Nama Siswa" required value="<?= $nama ?>" />
                <span class="input-group-addon">
                  <span class="glyphicon glyphicon-user"></span>
                </span>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="ranting" id="ranting" class="form-control" placeholder="Ranting" value="<?= $ranting ?>">
                <span class="input-group-addon">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="rayon" id="rayon" class="form-control" data-error="Rayon harus diisi" placeholder="Rayon" value="<?= $rayon ?>">
                <span class="input-group-addon">
                  <span class="fas fa-briefcase"></span>
                </span>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <select name="jenis_kelamin" id="jenis_kelamin" class="form-control" data-error="Jenis kelamin harus di isi" required>
                  ...
                  <option value="laki-laki" <?= $jk === "laki-laki" && 'selected'  ?>>
                    Laki-laki
                  </option>
                  <option value="perempuan" <?= $jk === "perempuan" && 'selected'  ?>>
                    Perempuan
                  </option>
                </select>
                <span class="input-group-addon">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="agama" id="agama" class="form-control" placeholder="agama" value="<?= $agama ?>">
                <span class="input-group-addon">
                  <span class="fas fa-briefcase"></span>
                </span>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="tanggal Lahir" value="<?= $tgl_lahir ?>" />
                <span class="input-group-addon">
                  <span class="glyphicon glyphicon-user"></span>
                </span>
              </div>
