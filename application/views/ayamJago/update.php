        ...
        <div class='col-xs-12'>
            <div class='box box-<?= $box; ?>'>
                <div class='box-header  with-border'>
                    <h3 class='box-title'>UPDATE AYAM JAGO</h3>
                </div>
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?= site_url("ayamjago/updateHandler/".$ayamJago->id_ayam_jago) ?>" method="post">
                        <div class="form-group">
                            <label for="nama" class="control-label">Nama Ayam Jago</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="nama" id="nama" data-error="Nama Ayam Jago harus diisi" value="<?= $ayamJago->nama ?>" placeholder="Nama Ayam Jago" required />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="TTL" id="TTL" class="form-control" placeholder="TTL" value="<?= $ayamJago->ttl ?>" data-error="Nama Ayam Jago harus diisi" required>
                                <span class="input-group-addon">
